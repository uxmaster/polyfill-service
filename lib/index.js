...
/**
 * @returns {array} - Every polyfill that is available within the project.
 */
...
/**
 * @param {string} - Name of a specific polyfill.
...
/**
 * @param {object} - Custom options to override default options.
